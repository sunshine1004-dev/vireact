...
class Sidebar extends Component {
  ...
  //     return;
  //   }
  //   // const { containerClassnames } = `${this.props} main-show-temporary`;
  //   const { containerClassnames } = this.props;
  //   let nextClasses = this.getMenuClassesForResize(`${containerClassnames} main-show-temporary`);
  ...
  openSubMenu(e, selectedParent) {
    ...
    const currentClasses = containerClassnames
      ...
      //   containerClassnames
      // );
      localStorage.setItem("sub_menu", "sub-show-temporary"+containerClassnames);
    this.setState({
          ...
          <div className="scroll">
            ...
            >
              ...
              >
                ...
                <NavItem>
                  <NavLink to="/app/dashboards/banks">
                    <i className="simple-icon-credit-card" />{" "}
                    Banks
                  </NavLink>
                </NavItem>
                <NavItem>
                  <NavLink to="/app/dashboards/users">
