...
class TopNav extends Component {
  ...
  window.sidebar = "main-show-temporary";
}
mobileMenuButtonClick(e, containerClassnames) {
  ...
  render() {
    ...
    return (
      <nav className="pl-3 navbar fixed-top">
        {/* <NavLink
          to="#"
...
{/* 
        ...
        <NavLink to={`/`} className="white d-flex mx-auto">
          <img width="100" src="/assets/img/logo-black.png" />
